          ...
          <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
            <form>
              ...
              >
                ...
                <button
                  type="button"
                  class="btn btn-primary btn-floating mt-1 mx-1"
                >
              ...
              <div :class="{ invalid: isPassword === 'invalid' }">
                <div class="form-outline mb-3">
                  ...
                  <label
                    ...
                    >Password - Invalid Password</label
                  >
                </div>
              </div>
...
export default {
  ...
  methods: {
    async login() {
      ...
      this.$store.state.user = await axios.post(
        "http://localhost:3000/user/login",
        loginUser
      );
      if (this.$store.state.user.data === "Invalid Email") {
        this.isEmail = "invalid";
      } else if (this.$store.state.user.data === "Invalid Password") {
